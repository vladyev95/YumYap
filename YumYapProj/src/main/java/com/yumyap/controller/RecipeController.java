...
public class RecipeController {
	...
	@RequestMapping(value ="/comment", method= {RequestMethod.POST}, consumes={
			MediaType.APPLICATION_JSON_VALUE}, produces = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<RecipeDto> createComment(@RequestBody RecipeDto recipe, @RequestBody Comment comment){
		System.out.println("creating a new comment");
		return new ResponseEntity<RecipeDto>(recipeService.addComment(recipe, comment), HttpStatus.OK);
	}
}
