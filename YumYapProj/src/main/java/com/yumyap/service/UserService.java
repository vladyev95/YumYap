...
public class UserService implements UserServiceInterface {
	...
	@Override
	public UserDto addFollowing(UserDto userDto, UserDto follower) {
		if (userDto == null || follower == null)
			return null;
		
		if (userDto.getFollowing() == null)
			userDto.setFollowing(new TreeSet<User>());
		
		userDto.getFollowing().add(new User(follower));
		
		return userDto;
	}

	@Override
	public List<User> getFollowing(UserDto userDto) {
		if (userDto == null || userDto.getFollowing() == null)
			return null;
		
		List<User> result = new ArrayList<User>();
		for (User u : userDto.getFollowing())
			result.add(u);
